...
class LobbiesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create lobby" do
    assert_difference('Lobby.count') do
      post lobbies_url, params: { lobby: { board: @lobby.board, company: @lobby.company, document: @lobby.document, entry: @lobby.entry, exit: @lobby.exit, name: @lobby.name, obs: @lobby.obs } }
    end
  ...
  test "should update lobby" do
    patch lobby_url(@lobby), params: { lobby: { board: @lobby.board, company: @lobby.company, document: @lobby.document, entry: @lobby.entry, exit: @lobby.exit, name: @lobby.name, obs: @lobby.obs } }
